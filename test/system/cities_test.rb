...
class CitiesTest < ApplicationSystemTestCase
  ...
  test "creating a City" do
    ...
    fill_in "Abbr", with: @city.abbr
    check "Isdst" if @city.isdst
    fill_in "Offset", with: @city.offset
    fill_in "Text", with: @city.text
    fill_in "Utc", with: @city.utc
    fill_in "Value", with: @city.value
